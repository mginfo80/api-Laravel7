...
Route::group([
    ...
    Route::get('/posts/{post}/relationships/auth', 'PostRelationshipController@author')
        ->name('posts.relationships.author');

    Route::get('/posts/{post}/auth', 'PostRelationshipController@author')
        ->name('posts.author');
